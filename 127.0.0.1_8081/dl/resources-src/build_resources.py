...
# Both / and /insights/<slug> resolve from the site root for static assets.
...
def render_page(
    ...
    og_image = og_image or "/og-image.png"
...
def main():
    ...
    # Sitemap and robots are owned by seo.py on this site. Do not overwrite
    # the current commercial files with the donor Resources copies.
